...
alongside the current excitement in consumer 3D printing, could be great market. The
target customer for that would be a digital fabrication hobbyist/enthusiast/early-adopter,
or even a small-scale manufacturer (machine shops). Our design focus for this market would be to
bring resolution to smaller than typical machining tolerances (0.1 mm) while
keeping the unit affordable (below \$500). However, we are excited to see what
...
particular potential applications of 3D scanning, as well as to research 
