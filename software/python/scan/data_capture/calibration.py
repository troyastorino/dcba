...
import image
from scan.util import print_obj_vars
...
def calibrate_with_checkerboard(capture, images, interiorCorners, sideLength):
    """
...
if __name__ == "__main__":
    ...
    # calibrate the camera
    cam = calibrate_with_checkerboard(capture, images, interiorCorners, sideLength)
