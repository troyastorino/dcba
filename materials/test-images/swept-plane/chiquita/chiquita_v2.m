...
objName   = 'chiquita';    % object name (should correspond to a data dir.)
calName   = 'calib';       % calibration source (also must be a data dir.)
seqName   = 'v2';          % sequence name (subdirectory of object)
allFrames = 1:196;         % all frames in this sequence
recFrames = 70:157;        % frames used for reconstruction
