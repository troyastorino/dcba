...
objName   = 'schooner';    % object name (should correspond to a data dir.)
calName   = 'calib';       % calibration source (also must be a data dir.)
seqName   = 'v1';          % sequence name (subdirectory of object)
allFrames = 1:250;         % all frames in this sequence
recFrames = 100:218;       % frames used for reconstruction
